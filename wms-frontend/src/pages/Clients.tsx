...
export function Clients() {
  ...
  return (
    <div className="page-container" style={{ background: '#F8FAFC', minHeight: '100vh', padding: '24px 32px', color: '#0F172A' }}>
      ...
      <div className="page-header" style={{ marginBottom: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 16 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 4 }}>
            <h1 className="page-title" style={{ margin: 0, fontSize: 24, fontWeight: 800, color: '#0F172A', letterSpacing: '-0.01em' }}>
          ...
          <p className="page-subtitle" style={{ margin: 0, color: '#64748B', fontSize: 13 }}>
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          ...
          <button 
            ...
            style={{ 
              ...
              borderRadius: 8, cursor: 'pointer', fontWeight: 600, boxShadow: '0 1px 3px rgba(0,0,0,0.05)'
            }}
          >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 14, marginBottom: 24 }}>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: '#0D9488', display: 'flex', alignItems: 'center', gap: 6 }}>
              <Building2 size={15} /> Total Depositantes
            </span>
            <span style={{ fontSize: 10, fontWeight: 700, padding: '2px 7px', borderRadius: 4, background: '#CCFBF1', color: '#0F766E' }}>
              3PL Multi-Cliente
            </span>
          </div>
          <div style={{ fontSize: 28, fontWeight: 800, color: '#0F172A', marginTop: 8 }}>
            {totalTodos} <span style={{ fontSize: 12, fontWeight: 500, color: '#64748B' }}>cuentas</span>
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span style={{ fontSize: 10, fontWeight: 700, padding: '2px 7px', borderRadius: 4, background: '#D1FAE5', color: '#047857' }}>
              100% Operativos
            </span>
          </div>
          <div style={{ fontSize: 28, fontWeight: 800, color: '#059669', marginTop: 8 }}>
            {totalActivos} <span style={{ fontSize: 12, fontWeight: 500, color: '#64748B' }}>clientes</span>
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{ fontSize: 28, fontWeight: 800, color: '#0284C7', marginTop: 8 }}>
            {totalSkusSum.toLocaleString()} <span style={{ fontSize: 12, fontWeight: 500, color: '#64748B' }}>partidas</span>
          </div>
        </div>
        ...
        <div style={{ 
          background: '#FFFFFF', 
          border: totalInactivos > 0 ? '1px solid #FECACA' : '1px solid #E2E8F0', 
          borderRadius: 12, padding: '16px 20px',
          boxShadow: '0 1px 3px rgba(0, 0, 0, 0.05)'
        }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: totalInactivos > 0 ? '#DC2626' : '#64748B', display: 'flex', alignItems: 'center', gap: 6 }}>
              <ShieldAlert size={15} /> Inactivos / Resguardo
            </span>
            <span style={{ fontSize: 10, fontWeight: 700, padding: '2px 7px', borderRadius: 4, background: totalInactivos > 0 ? '#FEE2E2' : '#F1F5F9', color: totalInactivos > 0 ? '#DC2626' : '#64748B' }}>
              Baja Lógica
            </span>
          </div>
          <div style={{ fontSize: 28, fontWeight: 800, color: totalInactivos > 0 ? '#DC2626' : '#64748B', marginTop: 8 }}>
            {totalInactivos} <span style={{ fontSize: 12, fontWeight: 500, color: '#64748B' }}>en resguardo</span>
          </div>
        </div>
      </div>
          ...
          <div style={{ display: 'flex', gap: 12, flex: 1, minWidth: 320, alignItems: 'center' }}>
            ...
            <div style={{ minWidth: 190, width: 200, flexShrink: 0 }}>
              <select 
                ...
                style={{ 
                  width: '100%',
                  padding: '9px 14px', fontSize: 13, background: '#FFFFFF', 
            ...
            <div style={{ position: 'relative', flex: 1, minWidth: 260 }}>
              <Search size={16} style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', color: '#0D9488', pointerEvents: 'none' }} />
              <input 
                type="text"
      ...
      {loading ? (
        <div style={{ textAlign: 'center', padding: '80px 20px', color: '#64748B' }}>
          <RefreshCw className="animate-spin" size={32} style={{ margin: '0 auto 12px', color: '#0D9488' }} />
          <div style={{ fontSize: 14, fontWeight: 600, color: '#0F172A' }}>Sincronizando catálogo de depositantes con Supabase...</div>
        </div>
      ) : filtered.length === 0 ? (
        <div style={{ 
          background: '#FFFFFF', 
          ...
          <Building2 size={48} style={{ margin: '0 auto 14px', color: '#94A3B8', opacity: 0.8 }} />
            ...
            return (
              ...
              >
                <div style={{ padding: '20px 24px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 16 }}>
                    ...
                    <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                      <div style={{ 
                        ...
                        background: c.activo === false ? '#F1F5F9' : '#CCFBF1', 
                        border: `1px solid ${c.activo === false ? '#E2E8F0' : '#99F6E4'}`, 
                        display: 'flex', alignItems: 'center', justifyContent: 'center', 
                        color: c.activo === false ? '#64748B' : '#0D9488',
                        flexShrink: 0
                      }}>
                        <Building2 size={24} />
                      </div>
                      ...
                      <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
                          ...
                          <span style={{ 
                            fontSize: 12, color: '#0284C7', fontFamily: 'monospace', fontWeight: 700, 
                        ...
                        <div style={{ display: 'flex', gap: 6, marginTop: 8, flexWrap: 'wrap', alignItems: 'center' }}>
                          ...
                          <span style={{ 
                            fontSize: 11, fontWeight: 700, padding: '3px 8px', borderRadius: 6,
                            background: c.reglaInventario === 'FEFO' ? '#FEF3C7' : '#ECFDF5', 
                            color: c.reglaInventario === 'FEFO' ? '#D97706' : '#059669', 
                            border: `1px solid ${c.reglaInventario === 'FEFO' ? '#FDE68A' : '#A7F3D0'}` 
                          }}>
                          ...
                          {c.requiereCaducidad && (
                            <span style={{ 
                              display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 11, fontWeight: 600, 
                              padding: '3px 8px', borderRadius: 6, background: '#FEE2E2', 
                    ...
                    <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                      <div style={{ textAlign: 'center', minWidth: 46 }}>
                        ...
                        <div style={{ fontSize: 11, color: '#64748B', fontWeight: 600 }}>SKUs</div>
                      </div>
                      ...
                      <div style={{ textAlign: 'center', minWidth: 46 }}>
                        ...
                        <div style={{ fontSize: 11, color: '#64748B', fontWeight: 600 }}>Ship-To</div>
                      </div>
                      ...
                      <div style={{ textAlign: 'center', minWidth: 46 }}>
                        ...
                        <div style={{ fontSize: 11, color: '#64748B', fontWeight: 600 }}>Previos</div>
                      </div>
                      ...
                      <button 
                        ...
                        style={{ 
                          ...
                          color: '#0F172A', borderRadius: 6, cursor: 'pointer' 
                        }}
                      >
                        <Settings2 size={14} style={{ color: '#0D9488' }} /> {canEditRules ? 'Editar Parámetros' : 'Ver Parámetros'}
                      </button>
                      ...
                      <button 
                        ...
                        style={{ padding: 8, color: '#64748B', background: 'transparent', border: 'none', cursor: 'pointer' }}
                  ...
                  <div style={{ display: 'flex', gap: 20, marginTop: 14, flexWrap: 'wrap', fontSize: 12, color: '#64748B' }}>
                    {c.telefono && (
                      <span style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                        <Phone size={13} style={{ color: '#0D9488' }} /> {c.telefono}
                      </span>
                    )}
                    {c.email && (
                      <span style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                        <Mail size={13} style={{ color: '#0D9488' }} /> {c.email}
                      </span>
                    )}
                    {(c.ciudad || c.estado) && (
                      <span style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                        <MapPin size={13} style={{ color: '#0D9488' }} /> {c.ciudad}{c.ciudad && c.estado ? ', ' : ''}{c.estado} ({c.pais || 'México'})
                      </span>
                    )}
                    {c.sitioWeb && (
                      <span style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                        <Globe size={13} style={{ color: '#0D9488' }} /> 
                        <a href={c.sitioWeb} target="_blank" rel="noreferrer" style={{ color: '#0284C7', textDecoration: 'none' }}>
                  ...
                  {/* Sección Expandida con Ficha Técnica 3PL */}
                  {expanded === c.id && (
                    <div style={{ 
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
                        ...
                        {/* Datos Fiscales */}
                        <div>
                          <h4 style={{ margin: '0 0 10px', fontSize: 13, fontWeight: 700, color: '#0D9488', display: 'flex', alignItems: 'center', gap: 6 }}>
                            <FileText size={14} /> Ficha Fiscal SAT
                          </h4>
                          <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr', gap: '6px 8px', fontSize: 12 }}>
                            <span style={{ color: '#64748B' }}>Régimen Fiscal:</span>
                            <strong style={{ color: '#0F172A' }}>{c.regimenFiscal || '601 (General de Ley)'}</strong>
                            <span style={{ color: '#64748B' }}>Uso CFDI Defecto:</span>
                            <strong style={{ color: '#0F172A' }}>{c.cfdiDefault || 'G03 (Gastos en general)'}</strong>
                            <span style={{ color: '#64748B' }}>Código Postal:</span>
                            <strong style={{ color: '#0F172A' }}>{c.codigoPostal || 'No registrado'}</strong>
                            <span style={{ color: '#64748B' }}>Dirección Fiscal:</span>
                            <span style={{ color: '#334155' }}>{c.direccionFiscal || 'No registrada'}</span>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div style={{ display: 'grid', gridTemplateColumns: '130px 1fr', gap: '6px 8px', fontSize: 12 }}>
                            <span style={{ color: '#64748B' }}>Método de Rotación:</span>
                            <strong style={{ color: c.reglaInventario === 'FEFO' ? '#D97706' : '#059669' }}>
                              {c.reglaInventario || 'FIFO'}
                            </strong>
                            <span style={{ color: '#64748B' }}>Lote Obligatorio:</span>
                            <strong style={{ display: 'inline-flex', alignItems: 'center', gap: 4, color: '#0F172A' }}>
                              {c.requiereLote ? <><CheckCircle2 size={13} style={{ color: '#059669' }} /> Sí (NOM-251)</> : <><X size={13} style={{ color: '#64748B' }} /> No</>}
                            </strong>
                            <span style={{ color: '#64748B' }}>Caducidad Obligatoria:</span>
                            <strong style={{ display: 'inline-flex', alignItems: 'center', gap: 4, color: '#0F172A' }}>
                              {c.requiereCaducidad ? <><CheckCircle2 size={13} style={{ color: '#059669' }} /> Sí (COFEPRIS/FDA)</> : <><X size={13} style={{ color: '#64748B' }} /> No</>}
                            </strong>
                            <span style={{ color: '#64748B' }}>Manejo Almacén:</span>
                            <strong style={{ color: '#0F172A' }}>{c.uomPrincipal} ({c.manejoInventario})</strong>
                            <span style={{ color: '#64748B' }}>Escaneo Unitario:</span>
                            <strong style={{ color: '#0F172A' }}>{c.escaneoIndividual ? 'Sí (1 a 1)' : 'Global por contenedor'}</strong>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: 12, display: 'flex', flexDirection: 'column', gap: 6 }}>
                            <div>
                              <span style={{ color: '#64748B' }}>Contacto Operativo: </span>
                              <strong style={{ color: '#0F172A' }}>{c.contactoPrincipal || 'No asignado'}</strong>
                            </div>
                            <div>
                              <span style={{ color: '#64748B' }}>Clientes Finales (Ship-To): </span>
                              <strong style={{ color: '#818CF8' }}>{c._count?.endCustomers || 0} registrados</strong>
                            </div>
                            <div>
                              <span style={{ color: '#64748B' }}>Lotes Físicos en Racks: </span>
      ...
      {/* MODAL DE ALTA / EDICIÓN CON CANDADO RBAC */}
      {showModal && (
        <div className="modal-overlay" onClick={() => setShowModal(false)} style={{ background: 'rgba(15, 23, 42, 0.5)', backdropFilter: 'blur(4px)', zIndex: 1100 }}>
          <div 
          ...
          >
            ...
            <div style={{ padding: '20px 24px', borderBottom: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{ 
                  ...
                  background: isEditing ? '#EFF6FF' : '#CCFBF1', 
                  border: `1px solid ${isEditing ? '#BFDBFE' : '#99F6E4'}`,
                  color: isEditing ? '#0284C7' : '#0D9488', 
                  display: 'flex', alignItems: 'center', justifyContent: 'center' 
                }}>
            ...
            <form onSubmit={handleSubmit} style={{ overflowY: 'auto', padding: '20px 24px', flex: 1 }}>
              ...
              {/* BARRA EJECUTIVA DE CONTROL RBAC & SIMULADOR DE ROLES */}
              <div style={{
                display: 'flex',
                alignItems: 'center',
                ...
                gap: 12,
                padding: '12px 16px',
                background: simulatedRole === 'OPERARIO' ? '#FEF2F2' : '#F0FDFA',
                borderRadius: 10,
                border: `1px solid ${simulatedRole === 'OPERARIO' ? '#FECACA' : '#99F6E4'}`,
                marginBottom: 20,
              }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{
                    width: 34, height: 34, borderRadius: 8,
                    background: simulatedRole === 'OPERARIO' ? '#FEE2E2' : '#CCFBF1',
                    color: simulatedRole === 'OPERARIO' ? '#DC2626' : '#0D9488',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    flexShrink: 0
                  }}>
                  ...
                  <div>
                    <div style={{ fontSize: 13, fontWeight: 700, color: simulatedRole === 'OPERARIO' ? '#991B1B' : '#115E59' }}>
                    ...
                    <div style={{ fontSize: 12, color: simulatedRole === 'OPERARIO' ? '#B91C1C' : '#0D9488' }}>
                      {simulatedRole === 'OPERARIO'
                ...
                <div style={{
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: simulatedRole === 'ADMIN' ? '#FFFFFF' : '#475569',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: simulatedRole === 'OPERARIO' ? '#FFFFFF' : '#475569',
              ...
              <div style={{ marginBottom: 20 }}>
                <div style={{ fontSize: 12, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: '#0D9488', marginBottom: 12, display: 'flex', alignItems: 'center', gap: 6 }}>
                  <Building2 size={15} /> 1. Identificación y Datos Fiscales SAT
                </div>

                <div className="form-row">
                  <div className="form-group" style={{ flex: 1 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>
                  ...
                  <div className="form-group" style={{ flex: 1.5 }}>
                    <label className="form-label" style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#334155', fontWeight: 600 }}>
                ...
                <div style={{
                  ...
                  fontSize: 12, color: '#134E4A', marginBottom: 14,
                  display: 'flex', alignItems: 'flex-start', gap: 8
                }}>
                  <Info size={16} style={{ color: '#0D9488', flexShrink: 0, marginTop: 1 }} />
                  <div>
                    <strong style={{ color: '#0D9488' }}>Reglas estándar sugeridas por giro:</strong> {activeRulesInfo.descripcion}
                  </div>
                </div>
                ...
                <div className="form-row">
                  ...
                  <div className="form-group" style={{ flex: 1 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>RFC</label>
                    <input 
                      className="form-input" 
                  ...
                  <div className="form-group" style={{ flex: 1 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>Régimen Fiscal (SAT)</label>
                    <input 
                      className="form-input" 
                ...
                <div className="form-row">
                  <div className="form-group" style={{ flex: 1.5 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>Dirección Fiscal</label>
                    <input 
                      className="form-input" 
                  ...
                  <div className="form-group" style={{ flex: 1 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>Código Postal</label>
                    <input 
                      className="form-input" 
                      placeholder="03940" 
                  ...
                  <div className="form-group" style={{ flex: 1 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>País</label>
                    <input 
                      className="form-input" 
                      placeholder="México" 
                      value={form.pais} 
                  ...
                  <div className="form-group" style={{ flex: 1 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>CFDI Defecto</label>
                    <input 
                      className="form-input" 
                      placeholder="G03, G01" 
              ...
              {/* SECCIÓN 2: REGLAS OPERATIVAS 3PL */}
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                  <div style={{ fontSize: 12, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: '#0D9488', display: 'flex', alignItems: 'center', gap: 6 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 12, marginTop: 14 }}>
                  ...
                  <label style={{
                    ...
                    background: form.requiereLote ? '#FEF3C7' : '#FFFFFF',
                    padding: '10px 14px', borderRadius: 8,
                    border: `1px solid ${form.requiereLote ? '#FDE68A' : '#E2E8F0'}`,
                    ...
                    />
                    <div>
                      <div style={{ fontWeight: 700, color: form.requiereLote ? '#D97706' : '#0F172A' }}>
                        Requiere Lote
                      </div>
                      <div style={{ fontSize: 11, color: '#64748B' }}>Obligatorio en andén</div>
                    </div>
                  </label>
                  ...
                  <label style={{
                    display: 'flex', alignItems: 'center', gap: 10, fontSize: 13,
                    cursor: canEditRules ? 'pointer' : 'not-allowed',
                    background: form.requiereCaducidad ? '#FEE2E2' : '#FFFFFF',
                    padding: '10px 14px', borderRadius: 8,
                    border: `1px solid ${form.requiereCaducidad ? '#FECACA' : '#E2E8F0'}`,
                    opacity: canEditRules ? 1 : 0.8
                  }}>
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <div>
                      <div style={{ fontWeight: 700, color: form.requiereCaducidad ? '#DC2626' : '#0F172A' }}>
                        Requiere Caducidad
                      </div>
                      <div style={{ fontSize: 11, color: '#64748B' }}>NOM-251 / COFEPRIS</div>
                    </div>
                  </label>
                  ...
                  <label style={{
                    display: 'flex', alignItems: 'center', gap: 10, fontSize: 13,
                    cursor: canEditRules ? 'pointer' : 'not-allowed',
                    background: form.escaneoIndividual ? '#E0F2FE' : '#FFFFFF', 
                    padding: '10px 14px', borderRadius: 8,
                    border: `1px solid ${form.escaneoIndividual ? '#BAE6FD' : '#E2E8F0'}`,
                    opacity: canEditRules ? 1 : 0.8
                  }}>
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <div>
                      <div style={{ fontWeight: 700, color: form.escaneoIndividual ? '#0284C7' : '#0F172A' }}>Escaneo 1 a 1</div>
                      <div style={{ fontSize: 11, color: '#64748B' }}>Láser por cada pieza</div>
                    </div>
                  </label>
                  ...
                  <label style={{
                    display: 'flex', alignItems: 'center', gap: 10, fontSize: 13,
                    cursor: canEditRules ? 'pointer' : 'not-allowed',
                    background: form.requiereAprobacion ? '#D1FAE5' : '#FFFFFF', 
                    padding: '10px 14px', borderRadius: 8,
                    border: `1px solid ${form.requiereAprobacion ? '#A7F3D0' : '#E2E8F0'}`,
                    opacity: canEditRules ? 1 : 0.8
                  }}>
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <div>
                      <div style={{ fontWeight: 700, color: form.requiereAprobacion ? '#059669' : '#0F172A' }}>Visto Bueno</div>
                      <div style={{ fontSize: 11, color: '#64748B' }}>Giving Out autoriza salida</div>
                    </div>
                  </label>
                </div>
              </div>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div className="form-row">
                  <div className="form-group" style={{ flex: 1.5 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>Contacto Principal</label>
                    <input 
                      className="form-input" 
                  ...
                  <div className="form-group" style={{ flex: 1 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>Teléfono</label>
                    <input 
                      className="form-input" 
                  ...
                  <div className="form-group" style={{ flex: 1.5 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>Email Operativo</label>
                    <input 
                      className="form-input" 
                      type="email" 
                ...
                <div className="form-row">
                  <div className="form-group" style={{ flex: 2 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>Sitio Web Corporativo</label>
                    <input 
                      className="form-input" 
                  ...
                  <div className="form-group" style={{ flex: 1 }}>
                    <label className="form-label" style={{ color: '#334155', fontWeight: 600 }}>Color Distintivo Portal</label>
                    <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                      <input 
                        type="color" 
                        value={form.colorPortal} 
                        onChange={e => setForm(f => ({ ...f, colorPortal: e.target.value }))} 
                        style={{ width: 40, height: 38, padding: 2, borderRadius: 6, border: '1px solid #CBD5E1', background: '#FFFFFF', cursor: 'pointer' }}
                      />
                      <input 
                        className="form-input" 
                        value={form.colorPortal} 
                        onChange={e => setForm(f => ({ ...f, colorPortal: e.target.value }))} 
                        style={{ flex: 1, fontFamily: 'monospace', background: '#FFFFFF', borderColor: '#CBD5E1', color: '#0F172A' }}
                      />
                    </div>
                  </div>
                </div>
      ...
      {clientToDelete && (
        <div className="modal-overlay" onClick={() => setClientToDelete(null)} style={{ background: 'rgba(15, 23, 42, 0.5)', backdropFilter: 'blur(4px)', zIndex: 1100 }}>
          <div 
            className="modal-content animate-scale-in" 
            onClick={e => e.stopPropagation()} 
            style={{ 
              maxWidth: 480, background: '#FFFFFF', border: '1px solid #E2E8F0', 
              borderRadius: 16, boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1)', padding: 0, overflow: 'hidden' 
            }}
          >
            <div style={{ padding: '20px 24px', borderBottom: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, color: '#DC2626' }}>
                ...
                <div>
                  <h3 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#0F172A' }}>¿Desactivar Depositante?</h3>
                  <p style={{ margin: '2px 0 0', fontSize: 12, color: '#64748B' }}>Baja lógica con resguardo de kárdex</p>
                </div>
              </div>
              <button 
                type="button" 
                onClick={() => setClientToDelete(null)}
                style={{ background: 'transparent', border: 'none', color: '#64748B', cursor: 'pointer', padding: 6, display: 'flex' }}
              >
                <X size={18} />
              </button>
            </div>

            <div style={{ padding: '20px 24px', fontSize: 13, color: '#475569' }}>
              <p style={{ margin: '0 0 14px' }}>
                Estás por desactivar al depositante <strong style={{ color: '#0F172A' }}>{clientToDelete.nombreComercial}</strong> (<span style={{ fontFamily: 'monospace', color: '#0284C7' }}>{clientToDelete.codigo}</span>).
              </p>
              <div style={{ padding: '12px 14px', background: '#FEF2F2', borderRadius: 8, border: '1px solid #FECACA', color: '#991B1B', fontSize: 12, display: 'flex', alignItems: 'flex-start', gap: 8 }}>
                <Lock size={16} style={{ flexShrink: 0, marginTop: 2, color: '#DC2626' }} />
                <div>
                  <strong style={{ color: '#DC2626' }}>Resguardo de Kárdex:</strong> Esta acción no eliminará registros históricos ni movimientos de inventario. El cliente simplemente ya no estará disponible para nuevos previos hasta ser reactivado.
                </div>
              </div>
            </div>
      ...
      {/* MODAL DE CONFIRMACIÓN DE REACTIVACIÓN */}
      {clientToReactivate && (
        <div className="modal-overlay" onClick={() => setClientToReactivate(null)} style={{ background: 'rgba(15, 23, 42, 0.5)', backdropFilter: 'blur(4px)', zIndex: 1100 }}>
          <div 
            className="modal-content animate-scale-in" 
            onClick={e => e.stopPropagation()} 
            style={{ 
          ...
          >
            <div style={{ padding: '20px 24px', borderBottom: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <div>
                  <h3 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#0F172A' }}>¿Reactivar Depositante?</h3>
                  <p style={{ margin: '2px 0 0', fontSize: 12, color: '#64748B' }}>Habilitación inmediata para andén y órdenes</p>
                </div>
              </div>
              <button 
                type="button" 
            ...
            <div style={{ padding: '20px 24px', fontSize: 13, color: '#475569' }}>
              <p style={{ margin: '0 0 14px' }}>
                Estás por reactivar al depositante <strong style={{ color: '#0F172A' }}>{clientToReactivate.nombreComercial}</strong> (<span style={{ fontFamily: 'monospace', color: '#0284C7' }}>{clientToReactivate.codigo}</span>).
              </p>
              <div style={{ padding: '12px 14px', background: '#ECFDF5', borderRadius: 8, border: '1px solid #A7F3D0', color: '#065F46', fontSize: 12, display: 'flex', alignItems: 'flex-start', gap: 8 }}>
                <CheckCircle2 size={16} style={{ flexShrink: 0, marginTop: 2, color: '#059669' }} />
                <div>
                  <strong style={{ color: '#059669' }}>Disponibilidad Operativa:</strong> Al reactivarlo, el depositante volverá a estar disponible de inmediato para recepción de previos, catálogo de SKUs y órdenes de despacho en el WMS.
                </div>
              </div>
            </div>
